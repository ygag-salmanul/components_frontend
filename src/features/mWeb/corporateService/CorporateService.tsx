    ...
    <div className={styles["container"]}>
      ...
      <div className={styles["container-description"]}>
        <p>
          ...
          mall. When you purchase one of our Gift Cards, you're not just giving
          a present; you're gifting an unforgettable experience.
          <br />
          <br />
          ...
          card's balance online as needed.
          <br />
          <br />
